...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <br>
        <div style='padding-bottom: 5px;'>
            <div style='font-size: 16px;'>Great news! Your project's summary and plan are all set and completed. Just take a look at document <b>PROJECT PLAN (PP)</b> and validate it at the provided <a href="{{$link}}">link.</a></div>
        </div>
        ...
        <div style='padding-bottom: 10px;'>
            <div style='font-size: 16px;'><b>Have a great day!</b></div>
        ...
        <div>
            <div style='font-size: 14px; color: rgb(127, 127, 127) !important;'>This email was generated automatically by iCoDE©. Please refrain from replying.</ก>
        </div>
    </body>
</html>
