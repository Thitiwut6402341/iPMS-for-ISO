...
class AcceptanceController extends Controller
{
    ...
    public function uploadAcceptance(Request $request)
    {
        try {
            ...
            $userDocVersion = $this->db->selectCollection("AcceptanceRecord")->aggregate($pipline);
            ...
            $path = getcwd() . "\\..\\images\\AcceptanceRecord\\";
            if (!is_dir($path)) mkdir($path, 0777, true);
            // $pathUsed = 'http://10.1.9.77/Project/iPMS-ISO/documents/'.$projectID.'/'; // local
            $pathUsed = "https://snc-services.sncformer.com/dev/iPMSISO/images/AcceptanceRecord/"; //server
            ...
            $upload = $this->db->selectCollection("AcceptanceRecord")->insertOne([
    ...
    public function GetAcceptance(Request $request)
    {
        try {
            ...
            $userDoc = $this->db->selectCollection("AcceptanceRecord")->aggregate($pipline);
            $dataUserDoc = array();
    ...
    public function EditAcceptance(Request $request)
    {
        try {
            ...
            $documentID = $request->document_id;
            $copyData = $this->db->selectCollection("AcceptanceRecord")->find(["_id" => $this->MongoDBObjectId($documentID)]);
            ...
            $pathUsed = "https://snc-services.sncformer.com/dev/iPMSISO/images/AcceptanceRecord/";
            $fileName = $documentName . "_" . $version . "_" . $timestamp . ".pdf";
            ...
            $update = $this->db->selectCollection("AcceptanceRecord")->updateOne(
